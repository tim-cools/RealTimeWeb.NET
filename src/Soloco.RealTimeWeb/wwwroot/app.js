...
var LogonPage = (function (_Component) {
    ...
    _createClass(LogonPage, [{
        ...
        value: function onClick() {
            ...
            var passwordInput = _refs.passwordInput;
            var confirmPasswordInput = _refs.confirmPasswordInput;

            var userName = userNameInput.getValue();
            var eMail = eMailInput.getValue();
            var password = passwordInput.getValue();
            var confirmPassword = confirmPasswordInput.getValue();
            _membership2.default.register(userName, eMail, password, confirmPassword);
        }
    }, {
        key: 'render',
        value: function render() {
